...
- [StructuredStreaming](https://cs.stanford.edu/~matei/papers/2018/sigmod_structured_streaming.pdf). Structured Streaming: A Declarative API for Real-Time Applications in Apache Spark. Michael Armbrust, Tathagata Das, Joseph Torres, Burak Yavuz, Shixiong Zhu, Reynold Xin, Ali Ghodsi, Ion Stoica, Matei Zaharia. SIGMOD 2018.
- [Chi](https://lsds.doc.ic.ac.uk/sites/default/files/p1140-mai-tr.pdf). Chi: A Scalable and Programmable Control Plane for Distributed Stream Processing Systems, Luo Mai, Kai Zeng, Rahul Potharaju, Le Xu, Steve Suh, Shivaram Venkataraman, Paolo Costa, Terry Kim, Saravanan Muthukrishnan, Vamsi Kuppa, Sudheer Dhulipalla, Sriram Rao. VLDB 2018.
